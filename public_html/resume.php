			...
			<body>
				...
				<div class="col-md-12">
					<div class="content-box">
						...
						<P>1836 Kentucky Street | Albuquerque, NM  87110  	  (505)249-2236 | christopher@christopherapaul.com</P>

				</div>
				<div class="row">
					<div class="col-md-12">
						<h2>SUMMARY OF QUALIFICATIONS</h2>
							<p>Focused, results-driven Web Developer and Front End Designer with recent Coding Boot Camp Certification from The CNM Stemulus Center and 6 years of experience working within fast paced work environments. Innovative and self-motivated professional who understands the technical aspects of design and development as well as the management strategies essential to successful completion. Experienced in supporting the full project cycle, from planning and development to implementation and management. Strong communication skills to work with individuals of all professional and technical levels. Natural ability to find code and learn new languages and systems quickly.  Proven record in accomplishing goals accurately and on time.</p>
					</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<h2>Education and Experience in:   </h2>
							<p>Full Stack Web Development and Front End Design  Programming/Coding  Websites, Software, and Applications
							Testing and Quality Assurance  Troubleshooting and Issue Resolution  Technical Documentation and Records
							Individual and Team Projects  Project Management  Upgrades and Enhancements  Emerging Technologies</p>
						</div>
						</div>
					<div class="row">
						<div class="col-md-12">
							...
							<p>
								<ul>
								<li>Bachelor of Science Degree, Environmental Sciences, Minor in Sustainability | University of New Mexico | 2013</li>
							<li>Deep Dive Coding Boot Camp Certification of Completion | CNM Stemulus Center | 2016
							Completed a 10-week web development boot camp on the fundamentals, languages, tools, and techniques utilized for building high-quality websites, software, and applications.</li>
							</ul>
							</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							...
							<ul>
								...
								<li> Test Environments (PHP unit testing) </li>
								<li> GitHub collaboration and version control tools</li>
								<li> Agile Development Methodology </li>
								<li> Web-based tools and applications </li>
								<li> Computer-aided design (AutoCAD) </li>
								<li> Sales tracking and customer management (Salesforce) </li>
								<li> Windows and Mac/Apple Operating Systems </li>
